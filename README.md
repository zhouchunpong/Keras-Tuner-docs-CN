...
以上背景内容受启发于李沐大神的炼丹文(https://zhuanlan.zhihu.com/p/23781756) ,而本文主要介绍的keras-tuner就是一种半自动炼丹炉，主要用于超参调优，免去调参之苦。**下面主要内容翻译自keras-tuner的官方文档（https://keras-team.github.io/keras-tuner/），同时也补充了些个人注释。在查看本文内容时建议先熟悉一下keras的语法，简单容易上手。** 
